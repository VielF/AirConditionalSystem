...
public:
  List();
  ~List();
  void insertAfterLast(uint8_t id,uint8_t y, uint8_t mo, uint8_t d, uint8_t h, uint8_t mi, uint8_t s, uint8_t pm, uint8_t eT, uint8_t cT);
  int readFirst(uint8_t* id, uint8_t* y, uint8_t* mo, uint8_t* d, uint8_t* h, uint8_t* mi, uint8_t* s, uint8_t* pm, uint8_t* eT, uint8_t* cT);
  int removeFirst();
  void readPosition(int pos,uint8_t* id, uint8_t* y, uint8_t* mo, uint8_t* d, uint8_t* h, uint8_t* mi, uint8_t* s, uint8_t* pm, uint8_t* eT, uint8_t* cT);
  void listAll();
};
