...
#define GPIO_LED         0
#define GPIO_RL_AIR  21

#define GPIO_BUTTON_START 1
#define GPIO_SENSOR_DOOR  2
#define GPIO_SENSOR_WINDOW 3

#define ONE_OR_TWO_SENSORS_ACTIVATE 1
#define TWO_SENSORS_DESAVTIVATE     0
...
#define UART_TX_BT_PIN 8
#define UART_RX_BT_PIN 9
...
#define UART_ID_BT   uart1
#define BAUD_RATE_BT 9600
#define DATA_BITS_BT 8
#define STOP_BITS_BT 1
#define PARITY_BT    UART_PARITY_NONE

#define DEVICE_ID_LOG 1

#define LOG_EVENT_TURN_ON_AIR       0x30 //DEVICE CONTRO 1 - ASCII
#define LOG_EVENT_TURN_OFF_AIR      0x31 //DEVICE CONTRO 1 - ASCII
...
#define LOG_HEADING                 0x01 // SOH - ASCII
#define LOG_INIT_EVENT_TRANSMISSION 0x02 // STX - ASCII
#define LOG_END_EVENT_TRANSMISSION  0x03 // ETX - ASCII
#define LOG_END_EVENT_LIST          0x04 // EOT - ASCII

#define LOG_INIT_EVENT_TRANSMISSION_SP 0x05 // Init transmisson by bluetooth tecnology to smartphone supervisor

//enum stateControl {stInit=0, stConfigure, stCount, stTurnon, stTurnoff, stShow, stIdle, stLed, stSound};

enum stateControl {stInit=0, stAirDisable, stAirEnable};
